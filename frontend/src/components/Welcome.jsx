...
export default function Welcome() {
  const { iniciar, loading, error, toggleTema, tema } = useSession()
        ...
        <div className="max-w-lg">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center shadow-lg">
              <svg className="w-8 h-8 text-primary-content" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <motion.p
            ...
            className="py-6 text-base-content/70 text-lg leading-relaxed"
          >
            Evaluación adaptativa tipo CENEVAL con mecánicas de juego.
            Responde preguntas, acumula puntos, mantén rachas y
            sube de nivel mientras el sistema se adapta a tu conocimiento.
          </motion.p>
          ...
          >
            <button
              className={`btn btn-primary btn-lg shadow-xl transition-all duration-300 ${
                loading ? 'btn-disabled' : 'hover:shadow-primary/50 hover:scale-105'
              }`}
              onClick={iniciar}
              disabled={loading}
            >
          ...
          <motion.div
            ...
            className="mt-8 flex items-center justify-center gap-6 text-xs text-base-content/40"
          >
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mt-6 alert alert-error"
            >
